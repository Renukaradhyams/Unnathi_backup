...
const certificates = [
  ...
  { title: "ZED Silver Rating – Quality Council of India", file: certificateMedia.zedSilver.src, preview: certificateMedia.zedSilver.src, fileType: "image" as const, alt: "ZED Silver Rating certificate awarded to UNNATHI CNC Technologies by Quality Council of India" },
      ...
      <section className="py-24 bg-background overflow-hidden">
        <div className="container grid md:grid-cols-2 gap-16 items-center">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={slideRight} className="md:order-2 relative">
            <img src={pageSectionMedia.about.sections.precisionSection.asset.src} alt="Precision Components" title="Precision Components" className="rounded-2xl shadow-elevated" loading="lazy" decoding="async" />
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {teamPhotos.map((photo, i) => (
              ...
              >
                ...
                <p className="absolute bottom-4 left-4 text-sm font-semibold text-primary-foreground">{photo.label}</p>
              </motion.div>
            ))}
          </div>
          <motion.p
