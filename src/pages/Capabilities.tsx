...
const services = [
  { icon: Cog, title: "Core CNC Services", img: pageSectionMedia.capabilities.sections.coreServices.asset.src, desc: "Comprehensive machining services delivered through advanced CNC platforms and experienced process teams.", items: ["Turning Operations", "VMC Machining", "Surface and Cylindrical Grinding", "Wire Cutting", "H-Boring & VTL"] },
  ...
  { icon: Layers, title: "Production Model", img: pageSectionMedia.capabilities.sections.productionModel.asset.src, desc: "We are experts in prototype and batch manufacturing programs for precision-engineered parts.", items: ["Prototype Development", "Batch Production", "Drawing-to-Part Execution", "Quality-Driven Delivery"] },
  { icon: Target, title: "Inspection & Quality Assurance", img: pageSectionMedia.capabilities.sections.inspection.asset.src, desc: "In-process and final inspection supported by calibrated instruments and advanced metrology capabilities.", items: ["Surface Table Inspection", "Digital Micrometer & Vernier", "Profile Projection", "Vision Measurement", "CMM & Contour Measurement", "Surface Roughness Analysis"] },
];
