        ...
        <div className="container">
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={slideLeft} className="space-y-6">
              ...
              {[
                { icon: MapPin, label: "Registered Office", value: "UNNATHI CNC Technologies Pvt. Ltd., Peenya Industrial Area, Bangalore – 560058, India" },
              ...
              <div className="rounded-2xl overflow-hidden shadow-card h-48 bg-muted">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3886.8694!2d77.5098!3d13.0302!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTPCsDAx!5e0!3m2!1sen!2sin!4v1234567890"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
                  loading="lazy"
                  title="UNNATHI CNC Location"
                />
              </div>
            </motion.div>
