...
const commonMachines: UnitMachine[] = [
  { id: "machine-spec-01", name: "CNC Turning Machine", brand: "ACE", model: "J300LM", axis: "2-Axis", image: machineImageSets.turning[0], images: machineImageSets.turning },
  { id: "machine-spec-02", name: "CNC Turning Machine", brand: "ACE Micromatic", model: "JOBBER LM", axis: "2-Axis", image: machineImageSets.turning[1], images: machineImageSets.turning },
  { id: "machine-spec-03", name: "CNC Turning Machine", brand: "Haas", model: "ST 20", axis: "2-Axis", image: machineImageSets.turning[2], images: machineImageSets.turning },
  { id: "machine-spec-04", name: "CNC Turning Machine", brand: "Jaguar", model: "LX20TL5", axis: "2-Axis", image: machineImageSets.turning[1], images: machineImageSets.turning },
  { id: "machine-spec-05", name: "VMC Milling Machine", brand: "BFW", model: "CHAKRA BMV60TC24", axis: "3-Axis", image: machineImageSets.vmc[0], images: machineImageSets.vmc },
  { id: "machine-spec-06", name: "VMC Milling Machine", brand: "Haas", model: "VF-2", axis: "3-Axis", image: machineImageSets.vmc[1], images: machineImageSets.vmc },
  { id: "machine-spec-07", name: "VMC Milling Machine", brand: "Phillips", model: "VMC", axis: "3-Axis", image: machineImageSets.vmc[2], images: machineImageSets.vmc },
  { id: "machine-spec-08", name: "Surface Grinding Machine", brand: "Cosmos", model: "Surface Grinder", axis: "—", image: machineImageSets.grinding[0], images: machineImageSets.grinding },
  { id: "machine-spec-09", name: "Surface Grinding Machine", brand: "Pinnacle", model: "Surface Grinder", axis: "—", image: machineImageSets.grinding[0], images: machineImageSets.grinding },
  { id: "machine-spec-10", name: "Cylindrical Grinding Machine", brand: "Micromatic", model: "ECO-200U", axis: "—", image: machineImageSets.grinding[1], images: machineImageSets.grinding },
  { id: "machine-spec-11", name: "Cylindrical Grinding Machine", brand: "Micromatic", model: "GCU-350", axis: "—", image: machineImageSets.grinding[1], images: machineImageSets.grinding },
  { id: "machine-spec-12", name: "Wire Cut Machine", brand: "Electronica", model: "Wire Cut", axis: "—", image: machineImageSets.wirecut[0], images: machineImageSets.wirecut },
  { id: "machine-spec-13", name: "TIG Welding Machine", brand: "INDUS-ARC", model: "TIG", axis: "—", image: machineImageSets.tig[0], images: machineImageSets.tig },
  { id: "machine-spec-14", name: "Orbital Welding Machine", brand: "ORBITRON", model: "Orbital", axis: "—", image: machineImageSets.orbital[0], images: machineImageSets.orbital },
  { id: "machine-spec-15", name: "H-Boring Machine", brand: "Union / BFW", model: "Heavy Duty", axis: "Horizontal", image: machineImageSets.heavy[0], images: machineImageSets.heavy },
  { id: "machine-spec-16", name: "VTL Machine", brand: "VTL", model: "Vertical Turning Lathe", axis: "Vertical", image: machineImageSets.heavy[2], images: machineImageSets.heavy },
];
