...
const commonMachines: UnitMachine[] = [
  { id: "machine-spec-01", name: "CNC Turning Centre", brand: "ACE", model: "J300LM", axis: "2-Axis", image: machineImageSets.turning[0], images: machineImageSets.turning },
  { id: "machine-spec-02", name: "CNC Turning Centre", brand: "PRIDE", model: "Unnati-1000", axis: "2-Axis", image: machineImageSets.turning[1], images: machineImageSets.turning },
  { id: "machine-spec-03", name: "CNC Turning Centre", brand: "ACE", model: "JOBBER LM", axis: "2-Axis", image: machineImageSets.turning[2], images: machineImageSets.turning },
  { id: "machine-spec-04", name: "CNC Turning Centre", brand: "HAAS", model: "ST 20", axis: "2-Axis", image: machineImageSets.turning[1], images: machineImageSets.turning },
  { id: "machine-spec-05", name: "CNC Turning Centre", brand: "JAGUAR", model: "LX20TL5", axis: "2-Axis", image: machineImageSets.turning[0], images: machineImageSets.turning },
  { id: "machine-spec-06", name: "CNC Turning Centre", brand: "PROTECK", model: "PL 500U", axis: "2-Axis", image: machineImageSets.turning[2], images: machineImageSets.turning },
  { id: "machine-spec-07", name: "Vertical Milling Centre", brand: "BFW", model: "CHAKRA", axis: "5-Axis", image: machineImageSets.vmc[0], images: machineImageSets.vmc },
  { id: "machine-spec-08", name: "Vertical Milling Centre", brand: "HAAS", model: "DTH1 / VF-2", axis: "3-Axis / 5-Axis", image: machineImageSets.vmc[1], images: machineImageSets.vmc },
  { id: "machine-spec-09", name: "Vertical Milling Centre", brand: "BFW", model: "AGNI+ / BMV Series", axis: "4-Axis", image: machineImageSets.vmc[2], images: machineImageSets.vmc },
  { id: "machine-spec-10", name: "Surface Grinding Machine", brand: "COSMOS", model: "E1050 / 114", axis: "3-Axis", image: machineImageSets.grinding[0], images: machineImageSets.grinding },
  { id: "machine-spec-11", name: "Cylindrical Grinding Machine", brand: "Micromatic", model: "GCU-350 / ECO-200U", axis: "1-Axis", image: machineImageSets.grinding[1], images: machineImageSets.grinding },
  { id: "machine-spec-12", name: "Wire Cutting Machine", brand: "Electronica", model: "2 Machines", axis: "1-Axis / 5-Axis", image: machineImageSets.wirecut[0], images: machineImageSets.wirecut },
  { id: "machine-spec-13", name: "Orbital Welding Machine", brand: "ORBITRON", model: "7000", axis: "Special Purpose", image: machineImageSets.orbital[0], images: machineImageSets.orbital },
  { id: "machine-spec-14", name: "Welding Machine", brand: "INDUS-ARC", model: "Max thickness 16 mm", axis: "Manual", image: machineImageSets.tig[0], images: machineImageSets.tig },
