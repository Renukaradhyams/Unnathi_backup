...
export const machineryDB: Machine[] = [
  ...
  },
  {
    ...
    controller: "FANUC",
    category: "CNC Turning Centers",
    images: [machineryMedia[4].src, machineryMedia[16].src],
  ...
  },
  {
    ...
    controller: "FANUC",
    category: "CNC Turning Centers",
    images: [machineryMedia[11].src, machineryMedia[17].src],
  ...
  },
  {
    ...
    controller: "FANUC",
    category: "CNC Turning Centers",
    images: [machineryMedia[17].src, machineryMedia[11].src],
  ...
  },
  {
    ...
    controller: "FANUC",
    category: "CNC Turning Centers",
    images: [machineryMedia[16].src, machineryMedia[4].src],
  ...
  },
  {
    ...
    controller: "FANUC",
    category: "Grinding Machines",
    images: [machineryMedia[8].src, machineryMedia[24].src],
  ...
  },
  {
    ...
    controller: "FANUC",
    category: "Grinding Machines",
    images: [machineryMedia[24].src, machineryMedia[8].src],
  ...
  },
  {
    ...
    controller: "FANUC",
    category: "Special Machines",
    images: [machineryMedia[25].src, machineryMedia[7].src],
