...
export const seoMedia = {
  homeHero: createAsset("seo-home-hero", "SEO Hero Image", "seo", mainFactory3, "src/assets/Main_photos/7.1aa.png", "Homepage OG and structured data image based on the main hero photo.", "image/png"),
